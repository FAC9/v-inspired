! function() {
  ...
  a = function(t) {
    ...
    return "small" === t ? (e.css += "font-size:14px; padding:5px 7px;", e.imgCss += "width:18px; padding-right: 6px;") : (e.css += "font-size:18px; padding:20px;", e.imgCss += "width:28px; padding-right: 10px;"), e
  },
  s = function(t, e, i) {
  ...
  t.renderTimeoutButton = function(t) {
    ...
    o.setAttribute("href", "#"), o.setAttribute("style", "position: absolute; background-color: rgba(52,156,244,0.96); top: 50%; left: 50%; color: white; cursor: pointer; transform: translate(-50%, -50%); height: 140px; width: 140px;"), o.innerHTML = '<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);background: url(https://www.yoti.com/dist/css/svg/sprite.css-05b3de2c.svg) 0 84.84848484848484% no-repeat; width: 32px; height: 35px;"></span>', e.appendChild(o), o.addEventListener("click", function(e) {
